        ...
        section_1: {
            contents: [
                ...
                },
                {
                    ...
                    url: '/services/remodeling/kitchen',
                    position: 'right'
                },
                {
                    image: {
                    ...
                    url: '/services/remodeling/bathroom',
                    position: 'left'
                },
            ]
        },
            ...
            contents: [
                {
                    ...
                    text: '室内设计',
                    remark: '规划梦想很大，先从家开始。',
                    url: '/services/design/interiordesign',
                    position: 'left'
                },
                {
                    image: {
                    ...
                    text: '软装设计',
                    remark: '精致方案的完美结尾。',
                    url: '/services/design/furnituredesign',
                    position: 'right'
                },
                {
                    image: {
            ...
            contents: [
                {
                    ...
                    title: '',
                    contents: [
                        '<p>在ZAIA建筑理念中，我们相信浴室不仅应该是美丽和实用的，更应该是您的放松身心的区域。从重新设计现有的浴室或改建浴室开始，我们的专家团队专注于您的需求，使用优质的材料来打造您梦想中的浴室。增加新型浴室功能，在符合您的预算与实现浴室功能的前提下，为您打造一个24小时，随时可以让您放松心理，舒缓疲惫的舒适空间</p>'
                    ],
                    images: [
                        {
                            src:'https://res.cloudinary.com/dgqsldchb/image/upload/v1615008487/zaia/remodeling/bathroom/claus-grunstaudl-I72dFJRFT3k-unsplash_gpgolx.jpg',
            ...
            contents: [
                {
                    ...
                    subtitle: '',
                    contents: [
                        '<p>我们为客户设计和改造各继续升级的厨房区域。从现代到经典，从简约到奢华，所有的厨房改造ZAIA建筑都使用优质材料和高端设计工艺为您打造最舒适的厨房区域。</p>',
                        '<p>ZAIA建筑是一家屡获殊荣的设计和建造公司，致力于为洛杉矶地区客户提供最好的厨房改造体验。我们的目标是为您提供一个既美观又实用的厨房区域，我们通过采用优质的材料、独家的设计风格结合高端的工艺来实现这一目标。</p>',
                        '<p>我们经验丰富的设计师将全程参与这一过程，从创建平面图，到选择橱柜材料和饰面，台面，后挡板，地板，电器，装置和墙面颜色等实施细节，ZAIA建筑全程与您同在。凭借超过20年的经验，我们已经帮助众多客户在极大的节省预算的前提下，打造出一个客户真正想要的厨房区域。</p>'
                    ],
                    images: [
                        {
                            src:'https://res.cloudinary.com/dgqsldchb/image/upload/v1615008465/zaia/remodeling/kitchen/beautiful-shot-modern-house-kitchen_bicwv4.jpg',
            ...
            contents: [
                {
                    ...
                    subtitle: '',
                    contents: [
                        '<p>大厅和门廊的改建可以提升房屋质量及观感，根据房屋自身的结构及周边的条件，同过ZAIA建筑的设计团队，打造适合您的生活状态和品味的家居环境，使您的门廊及客厅更具特色及舒适观感。</p>'
                    ],
                    images: [
                        {
                            src:'https://res.cloudinary.com/dgqsldchb/image/upload/v1615008476/zaia/remodeling/living/pexels-vecislavas-popa-1571460_exarhu.jpg',
            ...
            contents: [
                {
                    ...
                    title: '',
                    contents: [
                        '<p>如果您的房子感觉陈旧、不实用，或者根本不符合您的风格和个性，这就缺少了一个合适的室内设计方案而造成的。一个优秀的室内设计方案不仅能给您的家庭带来欢乐，提高您的生活品质，还能提升您的房产价值。</p>',
                        '<p>ZAIA的团队由持证建筑师、设计师和项目经理组成，专注于高端设计和工艺，为您提供最好的室内设计、改造方案，满足您的所有需求，彻底改变您的家。从翻新厨房和浴室，全屋的色彩风格，空间优化，到设计定制橱柜，ZAIA建筑的专业团队将从头到尾与您一起将您的愿景变为现实。</p>',
                        '<p>ZAIA建筑提供全方位服务的室内设计服务，可以一站式满足您的所有需求，我们通过利用高度专业化的施工团队、拥有多年经验积累的设计团队的通力配合，为您提供最佳服务，从而使您的方案与众不同。</p>'
                    ],
                    images: [
                        {
                            src:'https://res.cloudinary.com/dgqsldchb/image/upload/v1615008064/zaia/design/interiordesign/image_56_j2mk5l.jpg',
            ...
            contents: [
                {
                    ...
                    title: '',
                    contents: [
                        '<p>作为一家一站式的设计和施工企业，ZAIA建筑的大部分项目都是从建筑设计开始，到软装适配结束。无论客户进行的是新建筑、加建房间，还是完整的房屋改造，我们的软装设计师和建筑师都会通力合作，根据客户的预算，在完成硬装部分后，适配一个完美的软装方案。</p>',
                        '<p>一旦最终的平面图确立，我们的软装团队就会从工程设计进入项目，深入到整个施工的所有步骤中去，通过提供的涵盖空间规划、风格定位、色彩性格分析、软装潮流趋势解读等专业服务项目为客户，从项目设计的伊始就开始践行客户的软装理念，确保了从设计概念到最终成果呈现之间的平稳过渡。</p>'
                    ],
                    images: [
                        {
                            src:'https://res.cloudinary.com/dgqsldchb/image/upload/v1615008079/zaia/design/furnituredesign/pexels-pixabay-462235_1_utliia.jpg',
            ...
            contents: [
                {
                    ...
                    title: '',
                    contents: [
                        '<p>智能家居、物联网和非接触式技术已经成为建筑和室内设计行业不可磨灭的一部分，自动照明、智能暖通空调装置以及Alexa或Google Home等扬声器已经成为现代家庭的主要组成部分。随着新设备和竞争系统的不断推出，我们整合开发了最流行的家居技术，同时根据丰富的施工与设计经验，更新改进了这些技术中的使用方法与施工技巧。让您的房屋学会思考您的需求，解决您的问题。</p>'
                    ],
                    images: [
                        {
                            src:'https://res.cloudinary.com/dgqsldchb/image/upload/v1615008050/zaia/design/smarthome/smart-speaker-house-control-innovative-technology_1_qplfzz.jpg',
            ...
            contents: [
                {
                    ...
                    contents: [
                        ...
                        '<p>作为加州ADU项目专家，ZAIA建筑精通加州ADU项目政府法规，依靠雄厚的技术实力，并且全面整合行业资源，为您带来最具竞争力的工程建造成本！我们能够帮您合法申请ADU政府建设批文，合法加建后屋，或车库改成独立居住单元，让您的土地价值最大化，未来房屋租售两相宜。具体业务：提供加州ADU项目开发一站式服务，从ADU项目现场评估，施工图纸设计，政府批文申请，项目资金贷款，现场施工。我们将全程为您ADU项目保驾护航，使您的资产永续增值！</p>',
                    ],
                    images: [
                        {
                            src:'https://res.cloudinary.com/dgqsldchb/image/upload/v1615007962/zaia/construction/adu/henry-co-3coKbdfnAFg-unsplash_1_ximtli.jpg',
