    ...
    return {
        ...
        pargraphs: [
            ...
            },
            {
                ...
                contents: [
                    `<p>
                        ...
                        the time spent on those pages and other statistics. In addition, we may use third party services such 
                        as Google Analytics that collect, monitor and analyze. The Log Data section is for businesses that 
                        use analytics or tracking services in websites or apps, like Google Analytics. For the full disclosure 
            ...
            },
            {
                ...
                contents: [
                    `<p>
                        ...
                        materials and other information that. The Communications section is for businesses that may contact 
                        users via email (email newsletters) or other methods. For the full disclosure section, create your 
                        own Privacy Policy.
                    </p>`
                ]
            },
            ...
            },
            {
                ...
                contents: [
                    `<p>
                        This Privacy Policy is effective as of 1/5/2020 and will remain in effect except with respect to any
